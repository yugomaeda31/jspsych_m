...
var instruction2 = {
type: "html-button-response",
stimulus: "<p>これから顔画像の印象を評価していただきます。\nまず、すべての画像が0.5秒ずつ提示されます。<br>200枚の画像を表示します。時間は1分半ほどかかります。</p>",
choices: ["次へ"]
}
...
var instruction3 = {
type: "html-button-response",
stimulus: "<p>これから顔画像の印象を「全く魅力的でない」から「非常に魅力的」の7段階で評価していただきます。<br>そのとき、「全く魅力的でない」から「非常に魅力的」の7段階を満遍なく使用するように注意してください。</p>",
choices: ["次へ"]
}
